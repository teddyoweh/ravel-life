        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="hidden sm:flex h-10 items-center justify-center px-5 rounded-full bg-neutral-900 text-white text-sm font-medium transition-opacity hover:opacity-90"
            >
              Download App
            </a>
          </div>
      ...
      <main className="pt-16">
        <section className="min-h-[90vh] flex flex-col items-center justify-center px-6 py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                <Image
                  ...
                  width={80}
                  height={80}
                  className="rounded-2xl shadow-2xl shadow-neutral-200"
                  priority
                />
              </div>
            </div>
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight text-neutral-900 leading-[1.1] mb-6">
              Curate your style.
              <br />
              <span className="text-neutral-400">Share what you love.</span>
            </h1>

            {/* Subheadline */}
            <p className="text-lg sm:text-xl text-neutral-600 max-w-xl mx-auto mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 h-14 px-8 rounded-full bg-neutral-900 text-white font-medium transition-all hover:scale-[1.02] hover:shadow-lg"
              >
              ...
              <Link
                href="#features"
                className="flex items-center gap-2 h-14 px-8 rounded-full border border-neutral-200 text-neutral-700 font-medium transition-all hover:bg-neutral-50"
              >
                Learn more
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 h-14 px-8 rounded-full bg-neutral-900 text-white font-medium transition-all hover:scale-[1.02] hover:shadow-lg"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
              </svg>
      ...
      <footer className="py-12 px-6 border-t border-neutral-100 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 text-sm text-neutral-500">
            ...
            <a href="mailto:hello@ravel.life" className="hover:text-neutral-900 transition-colors">
              Contact
            </a>
          </div>
        </div>
