    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      ...
      <main className="pt-16 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          <div className="w-20 h-20 mx-auto mb-8 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/"
              className="flex h-12 items-center justify-center px-6 rounded-full bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-medium transition-opacity hover:opacity-90"
            >
              Go to Home
            </Link>
            ...
            <a
              ...
              className="flex h-12 items-center justify-center px-6 rounded-full border border-neutral-200 dark:border-neutral-800 text-neutral-700 dark:text-neutral-300 font-medium transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-900"
            >
              Download App
            </a>
          </div>
