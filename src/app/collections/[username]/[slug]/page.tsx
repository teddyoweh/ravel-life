  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-neutral-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a
            ...
            className="flex h-10 items-center justify-center px-5 rounded-full bg-neutral-900 text-white text-sm font-medium transition-opacity hover:opacity-90"
          >
            Get the App
          </a>
        </div>
      ...
      <main className="pt-16">
        <section className="px-6 py-12 border-b border-neutral-100">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              {collection.cover_image_url ? (
                ...
                <div className="w-24 h-24 rounded-2xl bg-neutral-100 flex items-center justify-center flex-shrink-0">
            ...
            {items.length > 0 ? (
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className="group bg-white rounded-xl overflow-hidden border border-neutral-100 transition-shadow hover:shadow-lg"
                  >
                    {/* Product Image */}
