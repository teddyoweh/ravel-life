...
export default async function OGImage({
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Warm gradient accent (left side) */}
        <div
          style={{
            position: "absolute",
            left: -120,
        ...
        >
          ...
          {/* Middle: Collection name (serif italic) */}
          <div
            style={{
              display: "flex",
              flexDirection: "column",
          ...
          {productImages.length >= 3 ? (
            ...
            >
              ...
              >
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={productImages[0].product_image_url!}
                    alt=""
                    style={{
                      width: "100%",
                      height: "100%",
                ...
                {productImages.length >= 4 ? (
                  ...
                  >
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={productImages[3].product_image_url!}
                      alt=""
                      style={{
                        width: "100%",
                        height: "100%",
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: 18,
                      background:
                        "linear-gradient(135deg, #f0ebe4, #e8e4de)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
              ...
              {/* Right column — inverse heights for stagger */}
              <div
                style={{
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={productImages[1].product_image_url!}
                    alt=""
                    style={{
                      width: "100%",
                      height: "100%",
                ...
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={productImages[2].product_image_url!}
                    alt=""
                    style={{
                      width: "100%",
                      height: "100%",
            ...
            <div
              style={{
                ...
                display: "flex",
                boxShadow:
                  "0 4px 12px rgba(0,0,0,0.04), 0 16px 40px rgba(0,0,0,0.1)",
              }}
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
